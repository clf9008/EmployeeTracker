...
//Function to add a department 
  ...
  //Function to add a role to a employee
  addRole = () => {
    inquirer.prompt([
      {
        type: 'input', 
 ...
 //Function to update an employee already in the system
 updateEmployee = () => {
  ...
  //Function to delete department from employee 
  deleteDepartment = () => {
  ...
  //Function to delete role from employee
  deleteRole = () => {
    const roleSql = `SELECT * FROM role`; 
  ...
  //Function to view the budget of the department 
  viewBudget = () => {
